...
"[project]/Project/capstone_project/frontend/app/dashboard/user/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UserDashboardPage() {
                ...
                "UserDashboardPage.useEffect.fetchDashboardData": async ()=>{
                    try {
                        ...
                        const latestCompleted = uploads.find({
                            "UserDashboardPage.useEffect.fetchDashboardData.latestCompleted": (u)=>u.status === "completed" && u.analysisId
                        }["UserDashboardPage.useEffect.fetchDashboardData.latestCompleted"]);
                        ...
                        const failedRules = (analysis.ruleResults || []).filter({
                            "UserDashboardPage.useEffect.fetchDashboardData.failedRules": (r)=>r.passed === false
                        }["UserDashboardPage.useEffect.fetchDashboardData.failedRules"]);
                        setData({
    ...
    const complianceStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project$2f$capstone_project$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "UserDashboardPage.useMemo[complianceStatus]": ()=>{
    ...
    const riskLevel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project$2f$capstone_project$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "UserDashboardPage.useMemo[riskLevel]": ()=>{
            if (!data) return "Low";
...
_s(UserDashboardPage, "KNp6PpiAQJyz4U5VSoUoXPxn5ro=", false, function() {
    return [
...
//# sourceMappingURL=Project_capstone_project_frontend_858f6c31._.js.map